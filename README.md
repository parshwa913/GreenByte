...
<table>
   <tr>
      ...
      <td align="center"><img src="Images/Admin%20login.png" alt="Admin login" width="240" /><br/>Admin login</td>
   ...
   <tr>
      ...
      <td align="center"><img src="Images/Climate%20action.png" alt="Climate action" width="240" /><br/>Climate action</td>
      <td align="center"><img src="Images/Customer%20home%20page.png" alt="Customer home page" width="240" /><br/>Customer home page</td>
   </tr>
   <tr>
      <td align="center"><img src="Images/Customer%20login.png" alt="Customer login" width="240" /><br/>Customer login</td>
   ...
   <tr>
      <td align="center"><img src="Images/Mission.png" alt="Mission" width="240" /><br/>Mission</td>
   ...
   <tr>
      <td align="center"><img src="Images/Recycler%20login.png" alt="Recycler login" width="240" /><br/>Recycler login</td>
      ...
      <td align="center"><img src="Images/Report%20generation.png" alt="Report generation" width="240" /><br/>Report generation</td>
   </tr>
</table>
...
2. **Environment Configuration**:
   Copy `backend.env.example` to `.env` and fill in your `MONGODB_URI` and `GEMINI_API_KEY` and self created admin creds.
3. **Start the Server**:
   ```bash
   npm run dev
   ```
